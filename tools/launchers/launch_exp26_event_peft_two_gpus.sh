...
launch_one "${GPU_EXP26_DAY}" \
  "exp26a_day_event_peft_adapter_only" \
  "configs/Mask2Former_SwinL_CoSEC_Exp26A_DayEventPEFTAdapterOnly.yaml"

launch_one "${GPU_EXP26_NIGHT}" \
  "exp26b_night_event_peft_adapter_predictor" \
  "configs/Mask2Former_SwinL_CoSEC_Exp26B_NightEventPEFTAdapterPredictor.yaml"
