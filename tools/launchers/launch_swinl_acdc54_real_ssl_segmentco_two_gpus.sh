...
launch_one \
  "real-ssl-acdc54-segmentco-eventactive" \
  "${SEGMENTCO_EVENTACTIVE_GPU:-0}" \
  "tools/run_swinl_acdc54_real_ssl_segmentco_eventactive.sh" \
  "work_dirs/real-ssl-acdc54_segmentco_eventactive_headonly_lr1e-7_bs3"

launch_one \
  "real-ssl-acdc54-segmentco-eventedge" \
  "${SEGMENTCO_EVENTEDGE_GPU:-1}" \
  "tools/run_swinl_acdc54_real_ssl_segmentco_eventedge.sh" \
  "work_dirs/real-ssl-acdc54_segmentco_eventedge_headonly_lr1e-7_bs3"
