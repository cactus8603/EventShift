...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/repro_bundle_20260629_portable_v2/
```
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/repro_bundle_20260629_portable.tar
size: 11G
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/repro_bundle_20260629_portable_v2.tar
size: 13G
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/repro_bundle_20260629_portable_v2_checkpoint_rebuild_04111.tar
size: 13G
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/repro_bundle_20260629_portable_v2_traincode_04111.tar
size: 13G
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_04085realvote_eventday_valpairnight_p50n100c500_b5comp60a5000_keepreal_20260629.zip
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/reports/sub_04085realvote_eventday_valpairnight_p50n100c500_b5comp60a5000_keepreal_explainable_delta_20260629.json
```
...
```text
/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_fulldescday_valpairnight_p50n100c500_b5comp60a5000_keepreal_20260629.zip
...
以下命令以 `/work/u1621738/ebmv_eccv/eccv_segment/swin_l` 為工作目錄。這些命令是 CPU/IO pipeline 記錄，不在本 bundle 內重新跑 GPU cache。

1. 從 val cache 產生 Night allow-pairs：

```bash
env PYTHONNOUSERSITE=1 /home/u1621738/miniconda3/bin/conda run --no-capture-output -n mask2former \
...
| --- | --- | --- |
| 0.4085 anchor | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_reqswin_04075base_seg_swin_m2f_min3_realvote_20260628.zip` | `84fdf54d98d1f4a0350436c644141bbe88c2033745720714b239e1eeead575b2` |
| Night repair intermediate | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_04085realvote_eventday_night_valrepairpairs_p50n100c500_b5comp60a5000_keepreal_20260629.zip` | `7241c1da7d3f56b14cd5f7a1084ee48212a3de4c648e18ec847b8713bc649ad4` |
| Primary keepreal candidate | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_04085realvote_eventday_valpairnight_p50n100c500_b5comp60a5000_keepreal_20260629.zip` | `58f94a40977ad90092fbd2a7789ce984b4fd9abc50da509e1bc55e55e5556dc7` |
| Day full-desc repair intermediate | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/full_desc_m2fday_segformer_valrepairpairs_p50n100c500_b5comp60a5000_20260629.zip` | `e86e8aac353afc67e1d0ed8c1e2f5c7b5894ba81db55f9f1bc497bef43a39cc6` |
| Full-desc Day val-positive candidate | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_fulldescday_valpairnight_p50n100c500_b5comp60a5000_keepreal_20260629.zip` | `2604c547a6092b425ec00ea522ccdb568db3fd0aba751a3844e7d7a1b67c6330` |
| REAL gate probe | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_04085realvote_eventday_valpairnight_p50n100c500_realgate60a5000_20260629.zip` | `c1d67a9b71fc00bc1b30ff0e03a8a9a3e3181b0b6a90752ac8243154895cdeba` |
| REAL fence probe | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/submission_zips/sub_04085realvote_eventday_valpairnight_p50n100c500_realfence_20260629.zip` | `6cd40a076f400cec04ce7c17929702423e92c5b7bc9f83e0fcd1f5b8830ccb9e` |
| Primary footprint report | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/reports/sub_04085realvote_eventday_valpairnight_p50n100c500_b5comp60a5000_keepreal_explainable_delta_20260629.json` | Day 2.4384%, Night 1.0288%, REAL 0.0000%, total 1.7958% changed vs anchor |
| Night repair summary | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/reports/sub_04085realvote_eventday_night_valrepairpairs_p50n100c500_b5comp60a5000_keepreal_summary_20260629.json` | applied pixels 2,357,391 |
| Day repair summary | `/work/u1621738/ebmv_eccv/eccv_segment/swin_l/work_dirs/submissions/reports/full_desc_m2fday_segformer_valrepairpairs_p50n100c500_b5comp60a5000_summary_20260629.json` | applied pixels 509,239 |
...
- `artifacts_manifest.tsv`: submission/report/allow-pairs/code/config manifest。
...
```bash
env PYTHONNOUSERSITE=1 /home/u1621738/miniconda3/bin/conda run --no-capture-output -n mmseg \
  python swin_l/tools/smoke_test_repro_bundle.py \
  --bundle work_dirs/submissions/repro_bundle_20260629_portable \
  --checks torch-load

env PYTHONNOUSERSITE=1 SKIP_CODE_BACKUP=1 /home/u1621738/miniconda3/bin/conda run --no-capture-output -n mask2former \
  python swin_l/tools/smoke_test_repro_bundle.py \
  --bundle work_dirs/submissions/repro_bundle_20260629_portable \
  --checks m2f
